...
function createLightbox() {
   ...
   //Lightbox prev slide bttn
   lightBox.appendChild(lbPrev);
   lbPrev.id = "lbPrev";
   lbPrev.innerHTML = "&#9664;";
   lbPrev.onclick = showPrev;

   //Lightbox next slide bttn
   ...
   //move forward through the image list
   function showNext() {
   ...
   //move backward through image list
   function showPrev() {
   ...
   function createOverlay() {
      ...
      let figureBox = document.createElement("figureBox");
